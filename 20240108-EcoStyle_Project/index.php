            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <span class="arizonia">Style</span></h2>
                    ...
                    <div class="col-md-12">
                        <form class="newsletter d-flex justify-content-center align-items-center" action="">
                            <div class="d-flex flex-column">
                                <p class="text-center"><span class="fs-2">10% GUTSCHEIN </span><br>und kostenloser Versand für die erste Bestellung</p>
   ...
   <?php include 'footer.php'; ?>
    ...
    <script>
        ...
        const monatsBilder = {
            ...
            7: {bild: 'imgs/h08.jpg'},
            8: {bild: 'imgs/h09.jpg'},
            9: {bild: 'imgs/h010.jpg'},
            10: {bild: 'imgs/h011.jpg'},
            11: {bild: 'imgs/h13.jpg'},
        };
